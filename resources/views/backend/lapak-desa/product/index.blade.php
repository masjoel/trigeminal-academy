                                    ...
                                    <table class="table-striped table">
                                        ...
                                        @foreach ($products as $index => $item)
                                            <tr>
                                                ...
                                                <td>{{ $item->name }}</td>
                                                <td class="text-right" width="100">{{ number_format($item->stock) }}</td>
                                                <td class="text-right" width="100">{{ number_format($item->price) }}</td>
                                                <td>{{ $item->lapakCategory->name }}</td>
                                                <td>{{ $item->lapakSuplier == null ? '' : $item->lapakSuplier->nama }}
                                                    <br>
                                                    <small
                                                        class="text-muted">{{ $item->lapakSuplier->nama_usaha ?? '' }}</small>
                                                </td>

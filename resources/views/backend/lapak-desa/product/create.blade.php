                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="row">
                                        <div class="form-group mb-4">
                                            ...
                                            <textarea class="form-control @error('description') is-invalid @enderror" data-height="90" name="description">{{ old('description') }}</textarea>
                                            @error('description')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div id="video_duration_wrapper">
                                            <input type="text" class="form-control @error('video_duration') is-invalid @enderror" name="video_duration" id="video_duration" placeholder="5" value="{{ old('video_duration') }}">

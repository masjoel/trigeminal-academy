                                ...
                                <div class="table-responsive">
                                    <table class="table-striped table">
                                        <tr>
                                            ...
                                            @can(['lapak-desa-kategori.edit', 'lapak-desa-kategori.delete'])
...
@push('scripts')
    <script>
        $(document).on("click", "a#delete-data", function(e) {
            e.preventDefault();
            let id = $(this).data('id');
            showDeletePopup(BASE_URL + '/lapak-desa-kategori/' + id, '{{ csrf_token() }}', '', '',
                BASE_URL + '/lapak-desa-kategori');
        });
    </script>
@endpush

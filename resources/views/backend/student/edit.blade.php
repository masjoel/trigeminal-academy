    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                ...
                <form id="fileForm" action="{{ route('student.update', $student) }}" method="POST"
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-group mb-4">
                                                <label>Alamat</label>
                                                <textarea class="form-control" name="alamat" data-height="30">{{ old('alamat', $student->alamat) }}</textarea>
                                            </div>
                                            <div class="form-group mb-4">
                                                <label>Catatan</label>
                                                <textarea class="form-control @error('keterangan') is-invalid @enderror" data-height="70" name="keterangan">{{ old('keterangan', $student->keterangan) }}</textarea>
                                                @error('keterangan')
                                                ...
                                                <div class="d-flex mt-2">
                                                    <label class="selectgroup-item me-5">
                                                        <input type="radio" name="approval" value="pending"
                                                            ...
                                                            {{ old('approval', $student->approval) == 'pending' ? 'checked' : '' }}>
                                                        <span class="selectgroup-button">Pending</span>
                                                    </label>
                                                    <label class="selectgroup-item me-5">
                                                        <input type="radio" name="approval" value="approved"
                                                            class="form-check-input"
                                                            {{ old('approval', $student->approval) == 'approved' ? 'checked' : '' }}>
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <div class="col-sm-12 col-md-9">
                                                    <div class="d-block text-left">
                                                        <img src="{{ $student->photo == null ? asset('img/example-image.jpg') : Storage::url($student->photo) }}"

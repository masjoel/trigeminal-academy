    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <form id="fileForm" action="{{ route('student.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-7">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-group mb-4">
                                                <label>Alamat</label>
                                                <textarea class="form-control" name="alamat" data-height="30">{{ old('alamat') }}</textarea>
                                            </div>
                                            <div class="form-group mb-4">
                                                <label>Catatan</label>

    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                ...
                <div class="card">
                    <form action="{{ route('galeri-foto.update', $galeri_foto) }}" method="POST"
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-9">
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-9">
                                            <input type="text" class="form-control @error('title') is-invalid @enderror"
                                                name="title" value="{{ old('title', $galeri_foto->title) }}" required>
                                            @error('title')
                                    ...
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-2 col-lg-2">Excerpt</label>
                                        <div class="col-sm-12 col-md-9">
                                            <textarea class="form-control" name="excerpt" cols="30" rows="3">{{ old('title', $galeri_foto->excerpt) }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-9">
                                            <textarea class="summernote" name="deskripsi">{{ $galeri_foto->deskripsi }}
                                            </textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                        ...
                                        <div class="d-flex mt-2">
                                            <label class="selectgroup-item me-5">
                                                <input type="radio" name="status" value="draft" class="form-check-input"
                                                    {{ $galeri_foto->status == 'draft' ? 'checked' : '' }}>
                                                <span class="selectgroup-button">Draft</span>
                                            </label>
                                            <label class="selectgroup-item me-5">
                                                <input type="radio" name="status" value="published"
                                                    class="form-check-input"
                                                    {{ $galeri_foto->status == 'published' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group mb-4">
                                        <div class="d-block text-left">
                                            <img src="{{ $galeri_foto->foto_unggulan == null ? asset('img/example-image.jpg') : Storage::url($galeri_foto->foto_unggulan) }}"

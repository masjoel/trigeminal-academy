    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                ...
                <div class="card">
                    <form action="{{ route('slidebanner.update', $slidebanner) }}" method="POST"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="text" class="form-control @error('title') is-invalid @enderror"
                                            name="title" value="{{ old('title', $slidebanner->title) }}"
                                            autocomplete="off">
                                        @error('title')
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <textarea name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" cols="30" rows="3">{{ old('deskripsi', $slidebanner->deskripsi) }}</textarea>
                                        @error('deskripsi')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-9">
                                            <div class="d-block text-left">
                                                <img src="{{ $slidebanner->image == null ? asset('img/example-image.jpg') : Storage::url($slidebanner->image) }}"

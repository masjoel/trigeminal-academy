                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-8 mx-auto">
                                    ...
                                    <div class="form-group row mb-4">
                                        <label>Excerpt</label>
                                        <textarea class="form-control" name="excerpt" cols="30" rows="3">{{ old('title', $artikel->excerpt) }}</textarea>
                                    </div>
                                ...
                                <div class="col-md-3">
                                        ...
                                        <select class="form-control select2" name="category_id">
                                            @foreach ($categories as $value)
                                                <option value="{{ $value->id }}"
                                                    {{ old('category_id', $artikel->category_id) == $value->id ? 'selected' : '' }}>
                                                    {{ $value->kategori }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group mb-5">
                                        ...
                                        <div class="d-flex mt-2">
                                            <label class="selectgroup-item me-5">
                                                <input type="radio" name="feature" value="0" class="form-check-input"
                                                    {{ $artikel->feature == '0' ? 'checked' : '' }}>
                                                <span class="selectgroup-button">Tidak</span>
                                            </label>
                                            <label class="selectgroup-item me-5">
                                                <input type="radio" name="feature" value="1" class="form-check-input"
                                                    {{ $artikel->feature == '1' ? 'checked' : '' }}>

                                ...
                                <div class="card-body">
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="text" name="url_ext"
                                            ...
                                            value="{{ old('url_ext', $link->url_ext) }}" placeholder="https://example.com/"
                                            autofocus>
                                        @error('url_ext')
                                        ...
                                        <div class="col-md">
                                            <div class="form-group mb-4">
                                                ...
                                                <input type="text" name="keterangan"
                                                    ...
                                                    value="{{ old('keterangan', $link->keterangan) }}">
                                                @error('keterangan')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group mb-4">
                                                ...
                                                <select name="tipe"
                                                    ...
                                                    <option value="medsos"
                                                        {{ old('tipe', $link->tipe) == 'medsos' ? 'selected' : '' }}>Media
                                                        Sosial</option>
                                                    <option value="external"
                                                        {{ old('tipe', $link->tipe) == 'external' ? 'selected' : '' }}>Link
                                                        Eksternal</option>
                                                </select>
                                                @error('tipe')
                                                    <div class="invalid-feedback">

            ...
            <div class="section-body">
                ...
                <div class="row mt-4">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header header-elements">
                                @can('galeri-video.create')
                                    <a href="{{ route('galeri-video.create') }}" class="btn btn-primary"><i
                                ...
                                <div class="table-responsive">
                                    <table class="table-striped table">
                                        <tr>
                                            ...
                                            @can(['galeri-video.edit', 'galeri-video.delete'])
...
@push('scripts')
    <script>
        $(document).on("click", "a#delete-data", function(e) {
            e.preventDefault();
            let id = $(this).data('id');
            showDeletePopup(BASE_URL + '/galeri-video/' + id, '{{ csrf_token() }}', '', '',
                BASE_URL + '/galeri-video');
        });
    </script>
@endpush

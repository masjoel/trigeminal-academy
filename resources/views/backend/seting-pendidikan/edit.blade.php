    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                ...
                <div class="card">
                    <form action="{{ route('seting-pendidikan.update', $seting_pendidikan) }}" method="POST"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="text" class="form-control @error('kategori') is-invalid @enderror"
                                            name="kategori" value="{{ old('kategori', $seting_pendidikan->kategori) }}"

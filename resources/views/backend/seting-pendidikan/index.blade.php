            ...
            <div class="section-body">
                ...
                <div class="row mt-4">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header header-elements">
                                @can('seting-pendidikan.create')
                                    <a href="{{ route('seting-pendidikan.create') }}" class="btn btn-primary"><i
                                ...
                                <div class="table-responsive">
                                    <table class="table-striped table">
                                        <tr>
                                            ...
                                            @can(['seting-pendidikan.create', 'seting-pendidikan.delete'])
...
@push('scripts')
    <script>
        $(document).on("click", "a#delete-data", function(e) {
            e.preventDefault();
            let id = $(this).data('id');
            showDeletePopup(BASE_URL + '/seting-pendidikan/' + id, '{{ csrf_token() }}', '', '',
                BASE_URL + '/seting-pendidikan');
        });
    </script>
@endpush
